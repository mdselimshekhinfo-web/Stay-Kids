...
export function ChildDevice({ state, openPermissions }: { state: StayKidsState; openPermissions: () => void }) {
          ...
          <div className="mt-4 rounded-[28px] border border-white/15 bg-white/8 p-5 space-y-3">
            ...
            <div className="mt-8 text-center">
              <button
                ...
                className="rounded-xl border border-white/20 bg-white/10 px-5 py-2.5 text-xs font-bold text-white hover:bg-white/20 shadow-sm transition"
              >
                ⚙️ Review Device Permissions
              </button>
            </div>
          </div>
        </div>
